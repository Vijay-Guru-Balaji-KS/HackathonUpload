    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("Zone"))
        {
            ...
            if (Input.GetKeyDown(KeyCode.F))
            {
                ...
                other.gameObject.GetComponentInParent<EnemyPatrol>().increaseDeathCount();
                ...
                Destroy(other.transform.parent.GetComponent<EnemyPatrol>().viewZone);
                Destroy(other.transform.parent.GetComponent<EnemyPatrol>().GetComponent<CapsuleCollider>());
